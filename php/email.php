    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-12">
                ...
                <ul class="inbox-menu">
                    <li class="active">
                        <a href="javascript:void(0);"><i class="fas fa-download"></i> Inbox
                    ...
                    <li>
                        <a href="javascript:void(0);"><i class="far fa-file-alt"></i> Drafts
                            ...
                            <div class="row">
                                <div class="col-lg-9 top-action-left col-sm-12">
                                    <div class="float-left">
                                        ...
                                        <div class="btn-group dropdown-action">
                                            <button type="button" data-bs-toggle="dropdown" class="btn btn-white dropdown-toggle">
                                ...
                                <div class="col-lg-3 top-action-right col-sm-12">
                                    <div class="text-end">
                                        <button type="button" title="Refresh" data-toggle="tooltip" class="btn btn-white d-none d-md-inline-block">
                                ...
                                <table class="table table-inbox table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="unread clickable-row">
                                            ...
                                            <td>
                                                <span class="mail-important"><i class="far fa-star"></i></span>
                                            </td>
                                        ...
                                        <tr class="clickable-row">
                                            ...
                                            <td>
                                                <span class="mail-important"><i class="far fa-star starred"></i></span>
                                            </td>
